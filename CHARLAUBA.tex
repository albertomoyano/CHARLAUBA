...
\addbibresource{./files/gbTeXbib-CHARLAUBA.bib}

% agregamos el glosario
% we added the glossary
\input{./files/gbTeXglo-CHARLAUBA.tex}
...
\else
	...
	\usepackage{hyperxmp}
	\input{./files/gbTeXmeta-CHARLAUBA.tex}
	\else
		\ifBNPDF
